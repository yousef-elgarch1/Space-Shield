...
const EarthGlobe = () => {
  ...
  const textures = useTexture({
    map: 'https://th.bing.com/th/id/R.ec630c78359612f7a0a6c37d6e18d37a?rik=Yozs0HunAVu%2bpQ&riu=http%3a%2f%2fcdn.wallpapersafari.com%2f75%2f25%2f3YQNdZ.jpg&ehk=jAQAtLnjrlosGLR3On6Nu8Dxo4p3vZ5SCca2IXN80NQ%3d&risl=&pid=ImgRaw&r=0',
      ...
      {isLoading && (
        <div className="absolute inset-0 flex items-center justify-center z-10 bg-black bg-opacity-50">
          <div className="text-white text-center">
            ...
            <p>Loadin debris data from MySQL...</p>
          </div>
        </div>
      )}
