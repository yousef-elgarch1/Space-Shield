...
const Index = () => {
  ...
  <span>{t('debris.orbit')}: 24,582</span>
</div>
        ...
        {activeTab === 'dashboard' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2">
              ...
              <h2 className="text-lg font-semibold text-space-light-gray mb-4">{t('visualization.earthView')}</h2>
<p className="text-muted-foreground">
  {t('visualization.viewingFullEarth')}
</p>
              </div>
            </div>
