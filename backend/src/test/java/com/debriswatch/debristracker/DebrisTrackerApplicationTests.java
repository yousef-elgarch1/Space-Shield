...
@SpringBootTest(
        ...
        classes = DebrisTrackerApplicationTests.MinimalConfig.class, webEnvironment = SpringBootTest.WebEnvironment.NONE)
class DebrisTrackerApplicationTests {

    @Test
    void contextLoads() {
        // If we get here, Spring started just fine—no DB, no .env, no JPA, no web
        // server.
    }
